...
using
    DockComponent.Output.Messages; // Using LOCAL messages only - no cross-component dependencies!
...
public class OutputViewModel : ReactiveObject, ITool
{
    ...
    public ObservableCollection<LogEntry> LogEntries =>
        _loggingDataService.FilteredEntries;
    ...
    public OutputViewModel(LoggingDataService loggingDataService)
    {
        ...
        ToggleAutoScrollCommand =
            ReactiveCommand.Create(() => AutoScroll = !AutoScroll);
        NavigateToSourceCommand =
            ReactiveCommand.Create<LogEntry>(NavigateToSource);
