...
public class InterPluginLogger : ILogger
{
    ...
    public void Debug(string message, string? filePath = null,
        int? lineNumber = null)
    {
        LogInternal("Debug", message, filePath, lineNumber);
    }

    public void Info(string message, string? filePath = null,
        int? lineNumber = null)
    {
        LogInternal("Info", message, filePath, lineNumber);
    }

    public void Warn(string message, string? filePath = null,
        int? lineNumber = null)
    {
        LogInternal("Warn", message, filePath, lineNumber);
    }

    public void Error(string message, string? filePath = null,
        int? lineNumber = null)
    {
        LogInternal("Error", message, filePath, lineNumber);
    }

    private void LogInternal(string level, string message, string? filePath,
        int? lineNumber)
    {
    ...
    public void Log(string level, string message, string? filePath = null,
        int? lineNumber = null)
    {
...
public interface ILogger
{
    ...
    void Log(string level, string message, string? filePath = null,
        int? lineNumber = null);
}